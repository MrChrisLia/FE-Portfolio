...
h7Button.addEventListener("click", () => {
  if (isH7TextVisible) {
    ...
    const text = "<ul><li>- Manage a Web Vulnerabilitiy Scanner and confirm potential vulnerabilities. </li><li>- Manage an Web Application Firewall.</li> <li>- Perform web penetration tests to to find potential vulnerabilities.</li><li>- Work with the SOC team during investigations</li></ul>";
...
luantaButton.addEventListener("click", () => {
    if (isLuantaTextVisible) {
        ...
        const text = "<ul><li>- Monitor server system health. </li><li>- Provide tier 1 investigations on servers.</li> <li>- Act as first line customer and product support.</li><li>- Work in a 24/7 shift schedule.</li></ul>";
...
if (isHessTextVisible) {
    ...
    const text = "<ul><li>- Instruct students aging from 2 to 15 in English language. </li><li>- Plan yearly events.</li> <li>- Prepare students to take English exams for overseas school admission.</li><li>- Manage Teacher-Student-Parent relations.</li></ul>";
